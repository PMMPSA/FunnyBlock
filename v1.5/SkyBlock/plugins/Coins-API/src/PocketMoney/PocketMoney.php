...
class PocketMoney extends PluginBase implements Listener
{
    ...
    public function onEnable()
    {
	 ...
	 $this->getLogger()->info("
	 §l§e*================================*
	  §l§a FRK bán plugin số 1 vn liên hệ fb.com/roremi.cf
	 §l§e*================================*");
...
break;
   ...
   $form->sendToPlayer($sender);
	...
	$form->setTitle("§0§l-+=[§4||§0]§2 ACOIN§0 [§4||§0]=+-");
	$form->addLabel("§l§a10.000 VND§e = §620 §2Acoin");
	$form->addLabel("§l§a20.000 VND §e=§6 30§2 Acoin");
	$form->addLabel("§l§a50.000 VND§e =§6 70 §2Acoin");
		$form->addLabel("§a§l100.000 VND §e=§6 150 §2Acoin");
			$form->addLabel("§l§a200.000 VND§e =§6 300 §2Acoin");
